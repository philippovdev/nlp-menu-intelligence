...
| tfidf-union-logreg-v2-001 | 2026-03-27 | working-tree | v2 | classification | TF-IDF word/char union + Logistic Regression | test | Macro-F1 = 0.7254 | Acc = 0.7361 | artifact: `docs/course/artifacts/tfidf-union-logreg-items-v2.json`; previous shipped baseline before the enriched sparse model |
| tfidf-enriched-logreg-v2-001 | 2026-04-03 | working-tree | v2 | classification | TF-IDF enriched sparse features + Logistic Regression | valid | Macro-F1 = 0.8065 | Acc = 0.8056 | artifact: `docs/course/artifacts/tfidf-enriched-logreg-items-v2.json`; raw text + cleaned name + slot features + targeted lexicon flags; strongest validation result so far |
| tfidf-enriched-logreg-v2-001 | 2026-04-03 | working-tree | v2 | classification | TF-IDF enriched sparse features + Logistic Regression | test | Macro-F1 = 0.8708 | Acc = 0.8750 | artifact: `docs/course/artifacts/tfidf-enriched-logreg-items-v2.json`; best held-out result in the current comparison and the backend runtime model |
...
| bio2-extraction-baseline-v2-001 | 2026-04-03 | working-tree | v2 | extraction | deterministic BIO2 extraction baseline | valid | Entity Micro-F1 = 1.0000 | Token Micro-F1 = 1.0000; artifact: `docs/course/artifacts/bio2-extraction-baseline-items-v2.json` | BIO2 tags derived from structured slot annotations for `NAME`, `PRICE`, `SIZE` |
| bio2-extraction-baseline-v2-001 | 2026-04-03 | working-tree | v2 | extraction | deterministic BIO2 extraction baseline | test | Entity Micro-F1 = 1.0000 | Token Micro-F1 = 1.0000; artifact: `docs/course/artifacts/bio2-extraction-baseline-items-v2.json` | same result as validation on the fixed BIO2 test split |
| bio2-token-logreg-v2-001 | 2026-04-03 | working-tree | v2 | extraction | contextual Logistic Regression BIO2 token classifier | valid | Entity Micro-F1 = 1.0000 | Token Micro-F1 = 1.0000; artifact: `docs/course/artifacts/bio2-token-logreg-items-v2.json` | learned whitespace-tokenized tagger with contextual token features |
| bio2-token-logreg-v2-001 | 2026-04-03 | working-tree | v2 | extraction | contextual Logistic Regression BIO2 token classifier | test | Entity Micro-F1 = 1.0000 | Token Micro-F1 = 1.0000; artifact: `docs/course/artifacts/bio2-token-logreg-items-v2.json` | learned BIO2 baseline matches the deterministic extractor on the released split |
