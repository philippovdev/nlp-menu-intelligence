...
from category_model_builders import (
    build_tfidf_linear_svm_parameters,
    build_tfidf_linear_svm_pipeline,
...
def main() -> int:
    ...
    output_path = resolve_repo_path(
        args.output or default_output_path(prefix="tfidf-linear-svm", dataset_path=dataset_path)
    )
    ...
    artifact = build_artifact(
        ...
        run_id=args.run_id or default_run_id(prefix="tfidf-linear-svm", dataset_path=dataset_path),
        run_date=args.run_date,
        commit_sha=args.commit_sha,
        method="tfidf_linear_svm",
        label_order=label_order,
        train_item_count=len(train_items),
        parameters=build_tfidf_linear_svm_parameters(),
        ...
        notes=default_notes(dataset_path=dataset_path, classifier_label="LinearSVC"),
    )
