...
The course project should be presented as a pipeline of measurable NLP tasks,
not only as a web application.
...
## What Counts as a Result in the Course Report

The report should treat the current system as a pipeline:
