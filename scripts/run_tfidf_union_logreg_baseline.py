...
from category_model_builders import (
    build_tfidf_union_logreg_parameters,
    build_tfidf_union_logreg_pipeline,
...
def build_pipeline() -> Pipeline:
    return build_tfidf_union_logreg_pipeline()
...
def main() -> int:
    ...
    output_path = resolve_repo_path(
        args.output or default_output_path(prefix="tfidf-union-logreg", dataset_path=dataset_path)
    )
    ...
    artifact = build_artifact(
        ...
        run_id=args.run_id or default_run_id(prefix="tfidf-union-logreg", dataset_path=dataset_path),
        run_date=args.run_date,
        commit_sha=args.commit_sha,
        method="tfidf_union_logistic_regression",
        label_order=label_order,
        train_item_count=len(train_items),
        parameters=build_tfidf_union_logreg_parameters(),
        ...
        notes=(
            ...
            "LogisticRegression with a word/char TF-IDF feature union."
        ),
    )
